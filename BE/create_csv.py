...
# --- 1. รายชื่อปลาที่ถูกต้อง (มีขีด Hyphen ตามที่คุณแก้) ---
...
# --- 2. คำอธิบายที่ปรับชื่อให้ตรงกับ List ด้านบนเป๊ะๆ ---
...
# --- 3. ฟังก์ชันสร้าง CSV (Simple Matching) ---
def create_csv_file():
    ...
    print(f"📊 Total rows: {len(data_rows)} / {len(ALLOWED_FISH_SPECIES)}")
    ...
    if missing:
        ...
        print("🎉 All 91 species matched perfectly!")
